...
describe('Opportunities page', () => {
  ...
  it('shows a partial failure banner when managed sites cannot load', async () => {
    ...
    expect(html).toContain('rounded-md border border-red-950 bg-neutral-900 text-neutral-300 p-8 border-l-4 border-l-red-500 text-neutral-500');
  ...
  it('shows a config-focused empty state when no sites have Search Console enabled', async () => {
    ...
    expect(html).toContain('rounded-md border border-neutral-800 bg-neutral-900/60 text-neutral-300 p-8 text-neutral-500');
    expect(html).toContain('h-auto flex flex-col items-center justify-center text-center');
