...
describe('Opportunities page', () => {
  ...
  it('shows a partial failure banner when managed sites cannot load', async () => {
    ...
    expect(html).toContain('border border-red-950 bg-neutral-900 text-neutral-300 rounded-lg border-l-4 border-l-red-500 p-8 text-neutral-500');
  ...
  it('shows a config-focused empty state when no sites have Search Console enabled', async () => {
    ...
    expect(html).toContain('border border-neutral-800 bg-neutral-900/60 text-neutral-300 rounded-lg p-8 text-center text-neutral-500');
