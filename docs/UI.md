...
- `Surface` — standard dashboard panel shell (`rounded-lg`, neutral border/background) for standalone card-like sections. Defaults to `p-5`; use `padding="none"` when the child component owns its spacing.
