...
- `TextButton` / `TextLink` — small text-only actions for table rows, inline clears, and other low-emphasis controls. Use `TextLink` for navigational actions that should render as Next links.
