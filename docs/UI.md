...
- `FormInput` / `FormTextarea` — shared dark form controls for config fields and dashboard forms. Use `monospace` for keys, URLs, and other literal values. Use `FormTextarea padding="roomy"` when preserving larger text-area padding.
